// Copied from mcp-use Inspector; see THIRD_PARTY_NOTICES.md.
"use client";
...
import { spring, exitFallbackMs } from "@/src/lib/springs";
import { useProximityHover } from "@/src/hooks/use-proximity-hover";
import { useShape } from "@/src/lib/shape-context";
import { Elevated } from "@/src/lib/elevated";
